...
const API_KEY = "df6b1a6459a2cbd1138f96aad7c43693"; // API key for OpenWeatherMap API
...
const getWeatherDetails = (cityName, latitude, longitude) => {
    const WEATHER_API_URL = `https://pro.openweathermap.org/data/2.5/forecast?lat=${latitude}&lon=${longitude}&appid=${API_KEY}`;
